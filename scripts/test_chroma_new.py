...
def main():
    """主函数"""
    print("🚀 开始ChromaDB 0.5.23版本测试")
    print("=" * 50)
    
    if test_chroma_0_5_23():
        print("=" * 50)
        print("🎉 所有测试通过！")
        print("ChromaDB 0.5.23版本配置成功")
        print("\n下一步:")
        print("1. 构建RAG索引: python -m RAG_Evidence4Organ.rag_system.build_rag_index")
